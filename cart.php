...
<body onload="render()">
    ...
    <?php include 'userWrapper.php'; ?>
        ...
        <div>
            <ul id="navbar">
                ...
                <li id="lg-bag"><a class="active" href="cart.php"><span id="cart_n"></span><i class="far fa-shopping-bag"></i></a></li>
    ...
    <section id="cart-add" class="section-p1">
        ...
        <div id="subtotal">
            ...
            <a href="buy.php"><button class="normal">Proceed to checkout</button></a>
        </div>
    </section>
