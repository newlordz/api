...
?>
                ...
                <div class="table-responsive ps">
                  <table class="table tablesorter " id="page1">
                    <thead class=" text-primary">
                      <tr><th>Image</th><th>Name</th><th>Price</th><th>Warehouse id</th><th>
	<a class=" btn btn-primary" href="addproduct.php">Add New</a></th></tr></thead>
                    ...
                    foreach($Products as $Product)
                        {
                        echo "<tr><td><img src='../$Product[Photo1]' style='width:50px; height:50px; border:groove #000'></td><td>$Product[Productname]</td>
                        <td>$Product[price]</td><td>$Product[warehouse]</td>
                        <td>

                        <a class=' btn btn-success' href='../connections/delete.php?delProductId=$Product[id]&action=delete'>Delete</a>
                        </td></tr>";
                        }
