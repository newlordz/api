        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../connections/signUp.php" method="post" name="form" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" id="phone" name="contact" class="form-control" required>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                          ...
                          <input type="text" name="gender" id="city"  class="form-control" required>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group">
                      ...
                      <div class="col-md-4">
                        <div class="form-group bmd-form-group" >
                          <label class="bmd-label-floating">Address</label>
                          <input type="text" name="loc" id="country" value="admin" class="form-control" required>
                        </div>
                      </div>
